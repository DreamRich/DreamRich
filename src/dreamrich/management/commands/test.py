...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            help=('Module paths to test; can be modulename, modulename.'
                  'TestCase or modulename.TestCase.test_method')
        )
        parser.add_argument(
            '--noinput', '--no-input', action='store_false',
            dest='interactive', help=('Tells Django to NOT prompt the user'
